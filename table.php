...
<div id="wrapper">
	...
	<form method="get" action="https://learncodeweb.com" class="form-inline my-2 my-lg-0">
		...
		<table id="customers" >
			...
			$result	=	$db->query("SELECT * FROM web WHERE 1  ORDER BY SUBSTRING(time, 0, 2) DESC ".$pages->limit."");
				...
				<tr>
					...
					<td align ="center"><a href ="table1.php?id=<?php echo mb_strtoupper($val['pk_web']);?>&page=<?php echo $pages->current_page;?>&ipp=7">คลิก</a></td>
				</tr>
				<?php 
					}
				}else{?>
