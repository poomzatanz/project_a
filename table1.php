	...
	<form method="get" action="https://learncodeweb.com" class="form-inline my-2 my-lg-0">
		...
		<table id="customers" align="center">
			...
			<tbody>
				...
				$sql = "SELECT coment1.text,web.time,web.link
				FROM web
				INNER JOIN coment1
			...
			$sql_forms = $db->query($sql);
			$pages->items_total = $sql_forms->num_rows;
			$pages->mid_range = 9;
			$pages->paginate();	
			 $sqli = "SELECT * FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web where web.pk_web = ".$get_id." ORDER BY SUBSTRING(time, 0, 2) DESC" ;
	        // echo $sqli;
